/**
 * Embed Data Full Permissions Plugin
 *
 * Demonstrates how to pass arbitrary data from the host application to Form.io
 * using the `hostData` feature. This version has ALL permissions enabled to
 * show conditional fields like Delete and Approve buttons.
 */
export const manifest = {
  slug: "embed-data-full-perms",
  name: "Embed Data (Full Permissions)",
  description:
    "Embed demo with all permissions enabled (canEdit, canDelete, canApprove).",
  ...
  hostData: {
    ...
    // ALL permissions enabled - Delete and Approve buttons will be visible
    permissions: {
      canEdit: true,
      canDelete: true,
      canApprove: true,
    ...
    context: {
      applicationName: "Embed Data Full Permissions",
      version: "1.0.0",
...
function onFormReady({ event, viewer }) {
  const prefix = "[embed-data-full-perms]";
